...
public class DBAdapter {
    ...
    static final String DATABASE_CREATE = "create table students (_id integer primary key autoincrement, " + "mssv text not null, name text not null, email text not null, phone_number text not null);";
    //Hàm tạo (contractor)
    ...
    public long insertStudent(String name, String mssv, String email, String phone_number) {
    ...
    public Cursor getStudent(int chiso) throws SQLException {
        Cursor mCursor =
                db.query(true, DATABASE_TABLE, new String[]{KEY_ROWID, KEY_MSSV, KEY_NAME, KEY_EMAIL, KEY_PHONE}, KEY_ROWID + "=" + chiso, null, null, null, null, null);
        if (mCursor != null) {
            mCursor.moveToFirst();
        }
        return mCursor;
    ...
    public boolean updateStudent(long rowId, String mssv, String name, String email, String phone_number) {
        ContentValues args = new ContentValues();
        args.put(KEY_NAME, mssv);
        args.put(KEY_NAME, name);
        args.put(KEY_EMAIL, email);
        args.put(KEY_PHONE, phone_number);
